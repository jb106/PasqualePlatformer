...
public class PlayerController : MonoBehaviour
{
    ...
    private void PlayerMovement()
    {
        ...
        //_rigid.velocity = new Vector3(_moveDirection.x, _rigid.velocity.y, _moveDirection.z);
    ...
    //Function that handle all inputs from the player (need to be separate from the fixed update)
    void PlayerInputs()
    {
        //Jump input
